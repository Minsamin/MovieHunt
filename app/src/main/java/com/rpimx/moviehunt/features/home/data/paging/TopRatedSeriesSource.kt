...
class TopRatedSeriesSource(private val api: Api) : PagingSource<Int, TvSeries>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, TvSeries> {
        return try {
            ...
            LoadResult.Page(
                data = topRatedSeries.results, prevKey = if (nextPage == 1) null else nextPage - 1, nextKey = if (topRatedSeries.results.isEmpty()) null else topRatedSeries.page + 1
            )
